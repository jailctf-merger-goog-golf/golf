...
// script.js
var SAFETY_KEY = localStorage.getItem("goog-safety-key");
if (SAFETY_KEY == "null") {
  SAFETY_KEY = null;
}
while (!SAFETY_KEY) {
...
var solutionView = new EditorView({
  parent: document.getElementById("editor"),
  doc: "",
  extensions: [basicSetup, python(), oneDark, [theme2], solutionListen]
});
var annotationsListen = EditorView.updateListener.of((v) => {
  if (v.docChanged) {
    websocketSendAnnotations();
  }
});
var annotationsView = new EditorView({
  parent: document.getElementById("annotations"),
  doc: "",
  extensions: [basicSetup, python(), coolGlow, [theme2], annotationsListen]
});
window.theme = theme2;
